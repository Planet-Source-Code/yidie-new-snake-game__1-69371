...
Dim lngDelaySpider As Long                                          '使蜘蛛延迟出现
Dim lngDelayMushroom As Long                                        '吃到蘑菇延迟

Private Sub Form_Unload(Cancel As Integer)
    Call SaveSetting(App.Title, Me.Name, "hight", hightScore)       '保存最高分
...
Private Sub Timer1_Timer()
    ...
    If PtInRect(rectFrog, x(0) + detaX * 15, y(0) - detaY * 15) Then
        ...
        Me.Caption = "贪食蛇  记录：" & hightScore & "  您的得分：" & score
        blnIsLast = True
    ...
    If PtInRect(rectMushroom, x(0) + detaX * 15, y(0) - detaY * 15) Then
        ...
        score = score + 10000&
        If hightScore < score Then hightScore = score
        Me.Caption = "Snake  hight score：" & hightScore & "  your score：" & score
...
Private Sub Timer2_Timer()
    ...
    If MsgBox("score：" & score & vbCrLf & "play again？", vbYesNo + vbInformation, "snake") = vbYes Then
        Timer1.Enabled = True
        Timer3.Enabled = True
        InitGame
    Else
